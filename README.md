...
* **-r**, **-removeannotations**: Specifies whether to remove capability annotations from the metadata. The default value is `true`. Only applicable for `-generationmode Transform` or `-generationmode TransformWitDocs`.
