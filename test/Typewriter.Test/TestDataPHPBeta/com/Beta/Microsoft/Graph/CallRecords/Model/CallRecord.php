...
class CallRecord extends \Beta\Microsoft\Graph\Model\Entity
{
    ...
    */
     ...
     *
     * @return \Beta\Microsoft\Graph\Model\IdentitySet[]|null The participants
     */
    ...
    */
     ...
     * Gets the recipients
     *
     * @return \Beta\Microsoft\Graph\Model\EntityType2[]|null The recipients
     */
    public function getRecipients()
    {
        if (array_key_exists('recipients', $this->_propDict) && !is_null($this->_propDict['recipients'])) {
           $recipients = [];
           if (count($this->_propDict['recipients']) > 0 && is_a($this->_propDict['recipients'][0], '\Beta\Microsoft\Graph\Model\EntityType2')) {
              return $this->_propDict['recipients'];
           }
           foreach ($this->_propDict['recipients'] as $singleValue) {
              $recipients []= new \Beta\Microsoft\Graph\Model\EntityType2($singleValue);
           }
