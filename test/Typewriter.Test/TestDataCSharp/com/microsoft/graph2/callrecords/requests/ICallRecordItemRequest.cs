...
namespace Microsoft.Graph2.CallRecords
{
    ...
    public partial interface ICallRecordItemRequest : Microsoft.Graph.IBaseRequest
    {
        ...
        /// <param name="callrecord">The CallRecord object set with the properties to update.</param>
        /// <returns>The <see cref="GraphResponse"/> object of the request</returns>
        System.Threading.Tasks.Task<GraphResponse<CallRecord>> PatchResponseAsync(CallRecord callrecord, CancellationToken cancellationToken = default);
        ...
        /// <param name="callrecord">The CallRecord object set with the properties to update.</param>
        /// <returns>The <see cref="GraphResponse"/> object of the request</returns>
        System.Threading.Tasks.Task<GraphResponse<CallRecord>> PutResponseAsync(CallRecord callrecord, CancellationToken cancellationToken = default);
