...
namespace Microsoft.Graph2.CallRecords
{
    ...
    public partial interface IOptionRequest : Microsoft.Graph.IBaseRequest
    {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        System.Threading.Tasks.Task<Option> PutAsync(Option optionToUpdate, CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<GraphResponse<Option>> PutResponseAsync(Option optionToUpdate, CancellationToken cancellationToken = default(CancellationToken));
