...
namespace Microsoft.Graph2.CallRecords
{
    ...
    /// <summary>
    /// The type PhotoContentRequest.
    /// </summary>
    public partial class PhotoContentRequest : Microsoft.Graph.BaseRequest, IPhotoContentRequest
    {
        /// <summary>
        /// Constructs a new PhotoContentRequest.
        /// <param name="requestUrl">The request URL.</param>
        /// <param name="client">The <see cref="Microsoft.Graph.IBaseClient"/> for handling requests.</param>
        /// <param name="options">Query option name value pairs for the request.</param>
        /// </summary>
        public PhotoContentRequest(
            string requestUrl,
