...
namespace Microsoft.Graph
{
    ...
    public partial interface ITestTypeRequest : IBaseRequest
    {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        System.Threading.Tasks.Task<TestType> PutAsync(TestType testTypeToUpdate, CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<GraphResponse<TestType>> PutResponseAsync(TestType testTypeToUpdate, CancellationToken cancellationToken = default(CancellationToken));
