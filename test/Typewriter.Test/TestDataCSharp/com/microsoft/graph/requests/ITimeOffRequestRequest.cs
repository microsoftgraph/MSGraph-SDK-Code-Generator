...
namespace Microsoft.Graph
{
    ...
    public partial interface ITimeOffRequestRequest : IBaseRequest
    {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        System.Threading.Tasks.Task<TimeOffRequestObject> PutAsync(TimeOffRequestObject timeOffRequestObjectToUpdate, CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<GraphResponse<TimeOffRequestObject>> PutResponseAsync(TimeOffRequestObject timeOffRequestObjectToUpdate, CancellationToken cancellationToken = default(CancellationToken));
