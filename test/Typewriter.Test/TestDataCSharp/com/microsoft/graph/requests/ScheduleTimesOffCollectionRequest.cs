...
namespace Microsoft.Graph
{
    ...
    public partial class ScheduleTimesOffCollectionRequest : BaseRequest, IScheduleTimesOffCollectionRequest
    {
        ...
        public async System.Threading.Tasks.Task<GraphResponse<TimeOff>> AddResponseAsync(TimeOff timeOff, CancellationToken cancellationToken = default(CancellationToken))
        {
            this.ContentType = Constants.ContentTypes.JsonContentType;
            this.Method = "POST";
