...
namespace Microsoft.Graph
{
    ...
    public partial interface IWorkbookChartRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<WorkbookChart> GetAsync(CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        System.Threading.Tasks.Task<WorkbookChart> PutAsync(WorkbookChart workbookChartToUpdate, CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// <param name="workbookChartToUpdate">The WorkbookChart object to update.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task of <see cref="GraphResponse{WorkbookChart}"/> to await.</returns>
        System.Threading.Tasks.Task<GraphResponse<WorkbookChart>> PutResponseAsync(WorkbookChart workbookChartToUpdate, CancellationToken cancellationToken = default(CancellationToken));
