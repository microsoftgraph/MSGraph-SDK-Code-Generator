...
namespace Microsoft.Graph
{
    ...
    public partial interface IPlannerGroupRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<PlannerGroup> GetAsync(CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{PlannerGroup}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<PlannerGroup>> GetResponseAsync(CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        System.Threading.Tasks.Task<PlannerGroup> PutAsync(PlannerGroup plannerGroupToUpdate, CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<GraphResponse<PlannerGroup>> PutResponseAsync(PlannerGroup plannerGroupToUpdate, CancellationToken cancellationToken = default(CancellationToken));
