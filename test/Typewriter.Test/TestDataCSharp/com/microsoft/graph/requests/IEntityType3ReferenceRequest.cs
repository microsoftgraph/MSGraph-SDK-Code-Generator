...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The interface IEntityType3ReferenceRequest.
    /// </summary>
    public partial interface IEntityType3ReferenceRequest : IBaseRequest
    {
        /// <summary>
        /// Deletes the specified EntityType3 reference.
        /// </summary>
        ...
        /// </summary>
        /// <param name="id">The EntityType3 reference reference to update.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task to await.</returns>
        System.Threading.Tasks.Task PutAsync(string id, CancellationToken cancellationToken = default(CancellationToken));

        /// <summary>
        /// Puts the specified EntityType3 reference and returns a <see cref="GraphResponse"/> object
        /// </summary>
        /// <param name="id">The EntityType3 reference reference to update.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The task of <see cref="GraphResponse"/> to await.</returns>
