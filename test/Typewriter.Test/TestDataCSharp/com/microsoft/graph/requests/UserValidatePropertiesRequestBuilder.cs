...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The type UserValidatePropertiesRequestBuilder.
    /// </summary>
    public partial class UserValidatePropertiesRequestBuilder : BaseActionMethodRequestBuilder<IUserValidatePropertiesRequest>, IUserValidatePropertiesRequestBuilder
    {
        /// <summary>
        ...
        protected override IUserValidatePropertiesRequest CreateRequest(string functionUrl, IEnumerable<Option> options)
        {
            var request = new UserValidatePropertiesRequest(functionUrl, this.Client, options);
