...
namespace Microsoft.Graph
{
    ...
    public partial interface ISingletonEntity2Request : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<SingletonEntity2> GetAsync(CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{SingletonEntity2}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<SingletonEntity2>> GetResponseAsync(CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<SingletonEntity2> UpdateAsync(SingletonEntity2 singletonEntity2ToUpdate, CancellationToken cancellationToken = default(CancellationToken));
