...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The type EntityType3ReferenceRequest.
    /// </summary>
    public partial class EntityType3ReferenceRequest : BaseRequest, IEntityType3ReferenceRequest
    {
        /// <summary>
        /// Constructs a new EntityType3ReferenceRequest.
        /// </summary>
        /// <param name="requestUrl">The URL for the built request.</param>
        /// <param name="client">The <see cref="IBaseClient"/> for handling requests.</param>
        /// <param name="options">Query and header option name value pairs for the request.</param>
        public EntityType3ReferenceRequest(
            string requestUrl,
            IBaseClient client,
