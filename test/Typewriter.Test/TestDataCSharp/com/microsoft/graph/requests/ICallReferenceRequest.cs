...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The interface ICallReferenceRequest.
    /// </summary>
    public partial interface ICallReferenceRequest : IBaseRequest
    {
        /// <summary>
        ...
        /// <summary>
        /// Deletes the specified Call reference and returns a <see cref="GraphResponse"/> object.
        /// </summary>
        ...
        /// </summary>
        /// <param name="id">The Call reference reference to update.</param>
        /// <returns>The task to await.</returns>
        ...
        /// <summary>
        /// Puts the specified Call reference and returns a <see cref="GraphResponse"/> object
        /// </summary>
        /// <param name="id">The Call reference reference to update.</param>
        /// <returns>The task of <see cref="GraphResponse"/> to await.</returns>
