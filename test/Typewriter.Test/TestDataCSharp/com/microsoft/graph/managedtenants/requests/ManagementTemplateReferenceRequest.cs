...
namespace Microsoft.Graph.ManagedTenants
{
    ...
    /// <summary>
    /// The type ManagementTemplateReferenceRequest.
    /// </summary>
    public partial class ManagementTemplateReferenceRequest : Microsoft.Graph.BaseRequest, IManagementTemplateReferenceRequest
    {
        /// <summary>
        /// Constructs a new ManagementTemplateReferenceRequest.
        /// </summary>
        /// <param name="requestUrl">The URL for the built request.</param>
        /// <param name="client">The <see cref="Microsoft.Graph.IBaseClient"/> for handling requests.</param>
        /// <param name="options">Query and header option name value pairs for the request.</param>
        public ManagementTemplateReferenceRequest(
            string requestUrl,
        ...
        /// <summary>
        /// Deletes the specified ManagementTemplate reference.
        /// </summary>
        ...
        /// <summary>
        /// Deletes the specified ManagementTemplate reference and returns a <see cref="GraphResponse"/> object.
        /// </summary>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        ...
        /// <summary>
        /// Puts the specified ManagementTemplate reference.
        /// </summary>
