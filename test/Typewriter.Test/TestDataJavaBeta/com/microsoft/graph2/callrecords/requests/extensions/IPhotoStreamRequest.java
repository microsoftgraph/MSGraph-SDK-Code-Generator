...
/**
 * The interface for the Photo Stream Request.
 */
public interface IPhotoStreamRequest extends IHttpStreamRequest {
     ...
     * @param callback the callback to be called after success or failure
     */
    void put(final byte[] fileContents, final ICallback<? super Photo> callback);
     ...
     * @throws ClientException an exception occurs if there was an error while the request was sent
     */
    Photo put(final byte[] fileContents) throws ClientException;
}
