 ...
 */
public class SegmentTestActionCollectionRequest extends BaseActionCollectionRequest<Session, SegmentTestActionCollectionResponse, SegmentTestActionCollectionPage> {


    /** The body for the method */
    @Nullable
    protected SegmentTestActionParameterSet body;
     ...
     */
    public SegmentTestActionCollectionRequest(@Nonnull final String requestUrl, @Nonnull final IBaseClient client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions, @Nonnull final SegmentTestActionParameterSet parameters) {
     ...
     */
    @Nonnull
    public SegmentTestActionCollectionRequest count(final boolean value) {
     ...
     */
    @Nonnull
    public SegmentTestActionCollectionRequest count() {
        addCountOption(true);
        return this;
    }
    /**
     ...
     */
    @Nonnull
    public SegmentTestActionCollectionRequest skip(final int value) {
        addSkipOption(value);
        return this;
    }
    /**
     ...
     */
    @Nonnull
    public SegmentTestActionCollectionRequest skipToken(@Nonnull final String skipToken) {
