...
import com.microsoft.graph2.callrecords.models.Option;
...
public class OptionRequestBuilder extends BaseRequestBuilder<Option> {
    ...
    public OptionRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph2.callrecords.requests.OptionRequest(getRequestUrl(), getClient(), requestOptions);
    }
