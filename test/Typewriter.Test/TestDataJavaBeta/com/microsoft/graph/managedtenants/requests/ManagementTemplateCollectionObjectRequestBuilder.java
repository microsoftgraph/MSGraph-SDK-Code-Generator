...
/**
 * The class for the Management Template Collection Object Request Builder.
 */
public class ManagementTemplateCollectionObjectRequestBuilder extends BaseRequestBuilder<ManagementTemplateCollectionObject> {
     ...
     */
    public ManagementTemplateCollectionObjectRequestBuilder(@Nonnull final String requestUrl, @Nonnull final IBaseClient<?> client, @Nullable final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
     ...
     *
     * @param requestOptions the options for this request
     * @return the ManagementTemplateCollectionObjectRequest instance
     */
    @Nonnull
    public ManagementTemplateCollectionObjectRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public ManagementTemplateCollectionObjectRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph.managedtenants.requests.ManagementTemplateCollectionObjectRequest(getRequestUrl(), getClient(), requestOptions);
    }
