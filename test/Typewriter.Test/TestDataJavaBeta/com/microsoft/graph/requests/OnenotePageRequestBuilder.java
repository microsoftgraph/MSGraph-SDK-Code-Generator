...
public class OnenotePageRequestBuilder extends BaseRequestBuilder<OnenotePage> {
     ...
     */
    @Nonnull
    public OnenotePageForwardRequestBuilder forward(@Nonnull final OnenotePageForwardParameterSet parameters) {
        return new OnenotePageForwardRequestBuilder(getRequestUrlWithAdditionalSegment("microsoft.graph.forward"), getClient(), null, parameters);
    }
}
