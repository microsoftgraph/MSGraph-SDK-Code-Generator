...
public class UserRequest extends BaseRequest<User> {
     ...
     */
    @Nonnull
    public java.util.concurrent.Future<? super User> futureGet() {
     ...
     */
    @Nonnull
    public java.util.concurrent.Future<? super User> futureDelete() {
     ...
     */
    @Nonnull
    public java.util.concurrent.Future<? super User> futurePatch(@Nonnull final User sourceUser) {
     ...
     */
    @Nonnull
    public java.util.concurrent.Future<? super User> futurePut(@Nonnull final User newUser) {
