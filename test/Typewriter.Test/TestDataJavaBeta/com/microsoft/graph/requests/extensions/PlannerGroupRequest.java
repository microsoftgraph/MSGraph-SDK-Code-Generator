...
public class PlannerGroupRequest extends BaseRequest<PlannerGroup> {
     ...
     */
    @Nonnull
    public java.util.concurrent.Future<? super PlannerGroup> futureGet() {
     ...
     */
    @Nonnull
    public java.util.concurrent.Future<? super PlannerGroup> futureDelete() {
     ...
     */
    @Nonnull
    public java.util.concurrent.Future<? super PlannerGroup> futurePatch(@Nonnull final PlannerGroup sourcePlannerGroup) {
     ...
     */
    @Nonnull
    public java.util.concurrent.Future<? super PlannerGroup> futurePost(@Nonnull final PlannerGroup newPlannerGroup) {
     ...
     */
    @Nonnull
    public java.util.concurrent.Future<? super PlannerGroup> futurePut(@Nonnull final PlannerGroup newPlannerGroup) {
