...
@implementation MSGraphTimeOffRequestRequest
...
- (MSURLSessionDataTask *)getWithCompletion:(void (^)(MSGraphTimeOffRequest *response, NSError *error))completionHandler
{
    MSURLSessionDataTask *sessionDataTask = [self taskWithRequest:[self get]
                                odObjectWithDictionary:^(NSDictionary *response){
                                            return [[MSGraphTimeOffRequest alloc] initWithDictionary:response];
                                        }
...
- (NSMutableURLRequest *)update:(MSGraphTimeOffRequest *)timeOffRequest
{
    NSData *body = [NSJSONSerialization dataWithJSONObject:[timeOffRequest dictionaryFromItem] options:0 error:nil];
...
{
    MSURLSessionDataTask *sessionDataTask = [self taskWithRequest:[self update:timeOffRequest]
                                odObjectWithDictionary:^(NSDictionary *response){
                                            return [[MSGraphTimeOffRequest alloc] initWithDictionary:response];
                                        }
                                              completion:completionHandler];
