...
@interface MSGraphSegmentForwardRequestBuilder()
...
@implementation MSGraphSegmentForwardRequestBuilder
...
- (MSGraphSegmentForwardRequest *)requestWithOptions:(NSArray *)options
{
    ...
    return [[MSGraphSegmentForwardRequest alloc] initWithToRecipients:self.toRecipients
