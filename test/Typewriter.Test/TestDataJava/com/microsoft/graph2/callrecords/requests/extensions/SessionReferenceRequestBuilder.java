...
public class SessionReferenceRequestBuilder extends BaseRequestBuilder {
     ...
     */
    @Nonnull
    public SessionReferenceRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public SessionReferenceRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
