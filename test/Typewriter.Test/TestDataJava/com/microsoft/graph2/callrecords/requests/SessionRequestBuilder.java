...
public class SessionRequestBuilder extends BaseRequestBuilder<Session> {
    ...
    public SessionRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
        return new com.microsoft.graph2.callrecords.requests.SessionRequest(getRequestUrl(), getClient(), requestOptions);
    }
     ...
     */
    @Nonnull
    public com.microsoft.graph2.callrecords.requests.SegmentCollectionRequestBuilder segments() {
        return new com.microsoft.graph2.callrecords.requests.SegmentCollectionRequestBuilder(getRequestUrlWithAdditionalSegment("segments"), getClient(), null);
    }
     ...
     */
    @Nonnull
    public com.microsoft.graph2.callrecords.requests.SegmentRequestBuilder segments(@Nonnull final String id) {
        return new com.microsoft.graph2.callrecords.requests.SegmentRequestBuilder(getRequestUrlWithAdditionalSegment("segments") + "/" + id, getClient(), null);
    }
}
