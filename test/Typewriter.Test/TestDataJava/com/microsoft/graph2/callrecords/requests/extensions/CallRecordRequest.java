...
public class CallRecordRequest extends BaseRequest<CallRecord> {
     ...
     */
    @Nonnull
    public java.util.concurrent.Future<? super CallRecord> futureGet() {
     ...
     */
    @Nonnull
    public java.util.concurrent.Future<? super CallRecord> futureDelete() {
     ...
     */
    @Nonnull
    public java.util.concurrent.Future<? super CallRecord> futurePatch(@Nonnull final CallRecord sourceCallRecord) {
     ...
     */
    @Nonnull
    public java.util.concurrent.Future<? super CallRecord> futurePost(@Nonnull final CallRecord newCallRecord) {
     ...
     */
    @Nonnull
    public java.util.concurrent.Future<? super CallRecord> futurePut(@Nonnull final CallRecord newCallRecord) {
