...
public class DirectoryObjectCollectionWithReferencesRequest extends BaseCollectionRequest<DirectoryObjectCollectionResponse, DirectoryObjectCollectionPage> {
    ...
    public void get(@Nonnull final ICallback<? super DirectoryObjectCollectionWithReferencesPage> callback) {
    ...
    @Nonnull
    public DirectoryObjectCollectionWithReferencesPage buildFromResponse(@Nonnull final DirectoryObjectCollectionResponse response) {
