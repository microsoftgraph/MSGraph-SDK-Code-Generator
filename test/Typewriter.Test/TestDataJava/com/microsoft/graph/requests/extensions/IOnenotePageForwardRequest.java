...
public interface IOnenotePageForwardRequest {
     ...
     */
    IOnenotePageForwardRequest select(final String value) ;
     ...
     * @return the updated request
     */
    IOnenotePageForwardRequest top(final int value);
     ...
     * @return the updated request
     */
    IOnenotePageForwardRequest expand(final String value);
