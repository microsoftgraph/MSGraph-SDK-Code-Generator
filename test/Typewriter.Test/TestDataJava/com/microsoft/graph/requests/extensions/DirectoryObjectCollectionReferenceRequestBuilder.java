 ...
 */
public class DirectoryObjectCollectionReferenceRequestBuilder extends BaseRequestBuilder {
     ...
     */
    @Nonnull
    public DirectoryObjectCollectionReferenceRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public DirectoryObjectCollectionReferenceRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
