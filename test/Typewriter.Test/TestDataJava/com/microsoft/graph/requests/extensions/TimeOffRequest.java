...
public class TimeOffRequest extends BaseRequest<TimeOff> {
     ...
     */
    @Nonnull
    public java.util.concurrent.Future<? super TimeOff> futureGet() {
     ...
     */
    @Nonnull
    public java.util.concurrent.Future<? super TimeOff> futureDelete() {
     ...
     */
    @Nonnull
    public java.util.concurrent.Future<? super TimeOff> futurePatch(@Nonnull final TimeOff sourceTimeOff) {
     ...
     */
    @Nonnull
    public java.util.concurrent.Future<? super TimeOff> futurePost(@Nonnull final TimeOff newTimeOff) {
     ...
     */
    @Nonnull
    public java.util.concurrent.Future<? super TimeOff> futurePut(@Nonnull final TimeOff newTimeOff) {
