...
public class OnenotePageRequest extends BaseRequest<OnenotePage> {
     ...
     */
    @Nonnull
    public java.util.concurrent.Future<? super OnenotePage> futureGet() {
     ...
     */
    @Nonnull
    public java.util.concurrent.Future<? super OnenotePage> futureDelete() {
     ...
     */
    @Nonnull
    public java.util.concurrent.Future<? super OnenotePage> futurePatch(@Nonnull final OnenotePage sourceOnenotePage) {
     ...
     */
    @Nonnull
    public java.util.concurrent.Future<? super OnenotePage> futurePut(@Nonnull final OnenotePage newOnenotePage) {
