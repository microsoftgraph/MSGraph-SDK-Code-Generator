...
public class OnenotePageContentStreamRequest extends BaseStreamRequest<OnenotePage> {
     ...
     */
    @Nonnull
    public java.util.concurrent.Future<? super InputStream> futureGet() {
        return futureSend();
    }
     ...
     */
    @Nonnull
    public java.util.concurrent.Future<? super OnenotePage> futurePut(@Nonnull final byte[] fileContents) {
