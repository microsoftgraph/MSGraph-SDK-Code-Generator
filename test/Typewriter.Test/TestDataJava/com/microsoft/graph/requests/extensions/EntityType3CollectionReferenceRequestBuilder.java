...
public class EntityType3CollectionReferenceRequestBuilder extends BaseRequestBuilder {
     ...
     */
    @Nonnull
    public EntityType3CollectionReferenceRequest buildRequest(@Nullable final com.microsoft.graph.options.Option... requestOptions) {
     ...
     */
    @Nonnull
    public EntityType3CollectionReferenceRequest buildRequest(@Nonnull final java.util.List<? extends com.microsoft.graph.options.Option> requestOptions) {
