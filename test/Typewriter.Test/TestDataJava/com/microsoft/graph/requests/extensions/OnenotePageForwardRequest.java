 ...
 */
public class OnenotePageForwardRequest extends BaseRequest implements IOnenotePageForwardRequest {
     ...
     */
    public IOnenotePageForwardRequest select(final String value) {
     ...
     * @return the updated request
     */
    public IOnenotePageForwardRequest top(final int value) {
     ...
     * @return the updated request
     */
    public IOnenotePageForwardRequest orderBy(final String value) {
