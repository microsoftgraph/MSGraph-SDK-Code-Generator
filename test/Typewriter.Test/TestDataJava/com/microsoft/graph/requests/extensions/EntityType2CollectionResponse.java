...
/**
 * The class for the Entity Type2Collection Response.
 */
public class EntityType2CollectionResponse implements IJsonBackedObject {

    /**
     * The list of EntityType2 within this collection page
     */
    @SerializedName("value")
    @Expose
    public java.util.List<EntityType2> value;
