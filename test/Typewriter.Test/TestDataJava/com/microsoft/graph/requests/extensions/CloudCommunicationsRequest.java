...
public class CloudCommunicationsRequest extends BaseRequest<CloudCommunications> {
     ...
     */
    @Nonnull
    public java.util.concurrent.Future<? super CloudCommunications> futureGet() {
     ...
     */
    @Nonnull
    public java.util.concurrent.Future<? super CloudCommunications> futureDelete() {
     ...
     */
    @Nonnull
    public java.util.concurrent.Future<? super CloudCommunications> futurePatch(@Nonnull final CloudCommunications sourceCloudCommunications) {
     ...
     */
    @Nonnull
    public java.util.concurrent.Future<? super CloudCommunications> futurePost(@Nonnull final CloudCommunications newCloudCommunications) {
     ...
     */
    @Nonnull
    public java.util.concurrent.Future<? super CloudCommunications> futurePut(@Nonnull final CloudCommunications newCloudCommunications) {
