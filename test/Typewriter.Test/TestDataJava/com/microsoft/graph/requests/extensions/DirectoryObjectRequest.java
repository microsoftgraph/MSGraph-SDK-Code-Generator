...
public class DirectoryObjectRequest extends BaseRequest<DirectoryObject> {
     ...
     */
    @Nonnull
    public java.util.concurrent.Future<? super DirectoryObject> futureGet() {
     ...
     */
    @Nonnull
    public java.util.concurrent.Future<? super DirectoryObject> futureDelete() {
     ...
     */
    @Nonnull
    public java.util.concurrent.Future<? super DirectoryObject> futurePatch(@Nonnull final DirectoryObject sourceDirectoryObject) {
     ...
     */
    @Nonnull
    public java.util.concurrent.Future<? super DirectoryObject> futurePost(@Nonnull final DirectoryObject newDirectoryObject) {
     ...
     */
    @Nonnull
    public java.util.concurrent.Future<? super DirectoryObject> futurePut(@Nonnull final DirectoryObject newDirectoryObject) {
