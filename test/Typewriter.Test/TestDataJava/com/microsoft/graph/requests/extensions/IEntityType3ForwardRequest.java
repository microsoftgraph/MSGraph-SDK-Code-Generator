...
public interface IEntityType3ForwardRequest {
     ...
     */
    IEntityType3ForwardRequest select(final String value) ;
     ...
     * @return the updated request
     */
    IEntityType3ForwardRequest top(final int value);
     ...
     * @return the updated request
     */
    IEntityType3ForwardRequest expand(final String value);
