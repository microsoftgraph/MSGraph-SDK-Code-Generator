...
/**
 * The class for the Unified Role Eligibility Request Filter By Current User Collection Response.
 */
public class UnifiedRoleEligibilityRequestFilterByCurrentUserCollectionResponse implements IJsonBackedObject {

    @SerializedName("value")
    @Expose
    public java.util.List<UnifiedRoleEligibilityRequest> value;
